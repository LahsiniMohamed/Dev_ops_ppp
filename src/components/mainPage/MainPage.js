...
function MainPage() {
    return (
        <div className="mainPage" style={{ backgroundImage: `url(${background})`,backgroundSize: 'cover' }}>
            <div className="mainPage__header">
                <button type="button" className = "mainPage__button" > RECOMMEND ME</button>
            ...
            <div className="mainPage__cards">
                <MovieSelect movie_info={movie_info} image={image} />
                <MovieSelect movie_info={movie_info} image='https://cdn.pastemagazine.com/www/system/images/photo_albums/best-movie-posters-2016/large/moonlight-ver2-xlg.jpg?1384968217' />
                <MovieSelect movie_info={movie_info} image= 'https://cdn.shopify.com/s/files/1/0969/9128/products/1917_-_Sam_Mendes_-_Hollywood_War_Film_Classic_English_Movie_Poster_a12704bd-2b25-4aa7-8c8d-8f40cf467dc7.jpg?v=1582781089'/>
                <MovieSelect movie_info={movie_info} image= 'https://cdn.seat42f.com/wp-content/uploads/2020/07/15192015/Project-Power-Movie-Poster-Jamie-Foxx.jpg'/>
                <MovieSelect movie_info={movie_info} image= 'https://cdn.shopify.com/s/files/1/0969/9128/products/1917_-_Sam_Mendes_-_Hollywood_War_Film_Classic_English_Movie_Poster_a12704bd-2b25-4aa7-8c8d-8f40cf467dc7.jpg?v=1582781089'/>
                <MovieSelect movie_info={movie_info} image='https://cdn.seat42f.com/wp-content/uploads/2020/07/15192015/Project-Power-Movie-Poster-Jamie-Foxx.jpg' />
                <MovieSelect movie_info={movie_info} image={image} />
                <MovieSelect movie_info={movie_info} image='https://cdn.seat42f.com/wp-content/uploads/2020/07/15192015/Project-Power-Movie-Poster-Jamie-Foxx.jpg' />
